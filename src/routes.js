        ...
        navigationOptions: () => ({
            tabBarIcon: ({tintColor}) => (    
                <View style={{ alignItems: 'center', justifyContent: 'flex-end' }}>
                    ...
                    color={tintColor}/>
                    <View>
                        <Text style={{ color: tintColor, fontSize: 10 }}>aplicativos</Text>
                    </View>
                </View>
            ),
        }),
    ...
    Profile: {
        ...
        navigationOptions: () => ({
            tabBarIcon: ({tintColor}) => (    
                <View style={{ alignItems: 'center', justifyContent: 'flex-end' }}>
                    <Image 
                    style={{height: tabbarConfigs.tabbar.config.iconePerfil.tamanhoImagemPerfil,
                    width: tabbarConfigs.tabbar.config.iconePerfil.tamanhoImagemPerfil,
